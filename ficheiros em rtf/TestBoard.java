...
// ***** VDMTOOLS START Name=TestBoardMove KEEP=NO
  public void TestBoardMove () throws CGException {
    ...
    try {
      Board b = new Board();
      AssertTrue(Boolean.valueOf(UTIL.equals(b.move(new Integer(0), new Integer(6), new Integer(0), new Integer(7)), new quotes.White())));
      AssertTrue(Boolean.valueOf(UTIL.equals(b.move(new Integer(0), new Integer(3), new Integer(5), new Integer(8)), new quotes.Black())));
    }
    finally {
