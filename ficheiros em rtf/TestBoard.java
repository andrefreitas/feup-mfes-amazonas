...
// This file was genereted from "C:\\Users\\Ana Gomes\\Desktop\\ficheiros em rtf\\TestBoard.rtf".
...
// ***** VDMTOOLS START Name=TestBoardSwitchTurn KEEP=NO
  public void TestBoardSwitchTurn () throws CGException {
    ...
    try {
      Board b = new Board();
      AssertTrue(Boolean.valueOf(UTIL.equals(b.switchTurn(new quotes.White()), new quotes.Black())));
      AssertTrue(Boolean.valueOf(UTIL.equals(b.switchTurn(new quotes.Black()), new quotes.White())));
    }
    finally {
